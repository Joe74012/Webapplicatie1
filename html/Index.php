...
<main>
    <div class="Achtergrond-Welkom">
        <div class="Linker-Rij">
            <div class="Text-Frame">
                <h2 class="Titel-Text">WELKOM BIJ TOKO RINUS</h2>
            </div>
            <div class="Knop-Rij">
                <a href="Menu.php">
                    <button class="Knop">
    ...
    <div class="Winkel-Rij">
        <div class="Winkel-Frame-Rechts">
            <img class="Afbeelding-Over-Ons" src="Afbeeldingen/Toko-Rinus-Over-Ons.jpg" alt="">
            <img class="Afbeelding-Over-Ons" src="Afbeeldingen/Toko-rinus-Afbeelding2.jpeg" alt="">
        </div>
